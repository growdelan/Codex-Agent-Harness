...
5. Samodzielne użycie tego skilla nie autoryzuje commita ani pusha. Jeśli poprawki są częścią nadrzędnego workflow, przekaż prowadzącemu wynik i walidację do zapisania checkpointu. Nie uruchamiaj własnej pętli review ani subagenta reviewera.
