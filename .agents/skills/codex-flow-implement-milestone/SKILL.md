...
Statusy, review i checkpointy prowadź według [kontraktu flow](../codex-flow-run-roadmap/references/flow-contract.md). W `run-roadmap` obowiązuje jego zakaz delegowania i końcowa walidacja integracji.
