...
5. Porównaj dokumentację i checkpoint z faktycznym stanem repo oraz historią Git. Sprawdź bazę, wynik review, walidacje i ewentualny commit milestone'u. Wznawiaj rozpoczętą pracę; nie powtarzaj zatwierdzonego milestone'u z powodu starego statusu. Jeśli commit się nie udał lub sesja urwała się przed checkpointem, ustal pozostały zakres z diffu i kodu. Nie zgaduj brakującego wyniku review.
