...
2. Ustal bazę i uzgodniony zakres. Stosuj procedurę diffu, własności zmian i fingerprintu z [kontraktu flow](../codex-flow-run-roadmap/references/flow-contract.md). W `run-roadmap` oceniaj cały przebieg, nie tylko ostatni milestone. Sprawdź zakres przed i po ocenie; wynik dotyczy konkretnej treści, także nowych plików.
