...
2. Użyj `$codex-flow-review` dla pełnego zakresu od stałej bazy według procedury z kontraktu, z kontrolą fingerprintu. Zapisz decyzję, zwięzły raport i ocenione ścieżki w checkpointie.
